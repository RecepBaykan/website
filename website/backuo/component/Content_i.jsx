  ...
  return (
    <>
      ...
      <div style={{
        ...
        overflow: "hidden", // Kenarların düzgün görünmesini sağlar
        padding: "20px", // İçerik ile kenar arasına boşluk ekler
        boxShadow: "0px 4px 8px rgba(0, 0, 0, 0.1)" // Hafif gölge ekler
      }}>
        {
          Body(content)
        }
              ...
              <div className='ql-snow'>
                <div className='ql-editor'
                  style={{
                    ...
                    marginTop: '20px',
                    padding: '10px',
                    boxSizing: 'border-box' // Padding'in içeriği etkileyici şekilde görünmesini sağlar
                  }}
